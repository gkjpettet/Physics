...
#tag WindowCode
	...
	#tag Method, Flags = &h0, Description = 447261777320612063697263756C61722067726F7570206F66207061727469636C65732061742060776F726C64506F73602E
		Sub DemoClickToAddParticlesClickHandler(worldPos As VMaths.Vector2, optionClick As Boolean)
		  /// Draws a circular group of particles at `worldPos`.
		  
		  #Pragma Unused optionClick
	...
	#tag Method, Flags = &h0, Description = 436F6E666967757265207468652073696D756C6174696F6E20666F7220746865207061727469636C65732064656D6F2E
		Sub DemoParticles()
		  ...
		  CheckBoxWireframes.Value = False
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0, Description = 5265736574732074686520776F726C642773206772617669747920766563746F7220746F2028302C202D3130292E
		Sub ResetGravity()
...
#tag Events Scene
	#tag Event , Description = 54686520757365722068617320636C69636B6564207468652063616E7661732E20496620606F7074696F6E436C69636B602069732054727565207468656E2074686520606F7074696F6E6020636C69636B207761732068656C6420646F776E207768656E20746865206D6F7573652077617320636C69636B65642E
		Sub Clicked(worldPos As VMaths.Vector2, optionClick As Boolean)
		  ...
		  Case Demo.Types.Particles
		    DemoClickToAddParticlesClickHandler(worldPos, optionClick)
...
#tag Events WorldUpdateTimer
	#tag Event
		Sub Action()
		  ...
		  If(World.ParticleSystem <> Nil, "Particles: " + World.ParticleSystem.ParticleCount.ToString, "") + EndOfLine + _
		  "      FPS: " + fps.ToString
...
#tag Events PopupDemos
	#tag Event
		Sub Opening()
		  ...
		  Me.RowTagAt(Me.LastAddedRowIndex) = Demo.Types.Particles
		  ...
		  Me.RowTagAt(Me.LastAddedRowIndex) = Demo.Types.Raycasting
